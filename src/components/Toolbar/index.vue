...
<!--    <el-button v-if="refresh"  size="small" icon="el-icon-refresh" circle :title="_text.refreshBtn" @click="doRefresh"/>-->
    ...
    <el-button v-if="columns!=null" size="small" icon="el-icon-s-operation" circle :title="_text.columnsSetBtn"  @click="doColumnsFilter"/>
...
<script>
  import D2TableColumnsFilter from './TableColumnsFilter/component'
